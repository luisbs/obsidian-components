...
- label: Season 1 - OP E1-13
  ...
  spotify: [6rsbsdiGDrYvhbb1K7ziTL, 70p3HYq9iHZisJqpDmWd1U]

- label: Season 1 - ED E1-13
  title: [Utsukushiki Zankoku na Sekai, (美しき残酷な世界)]
  author: Yoko Hikasa
  spotify: 1LmIptfyl5QZANQYxuwvhK

- label: Season 1 - OP E14-25
  title: [Jiyuu no Tsubasa, (自由の翼)]
  author: Linked Horizon
  spotify: 188vCXc4bAejLqGhpEVBGT

- label: Season 1 - ED E14-25
  title: great escape
  author: Cinema Staff
  spotify: 0iXYLrcgvd9u6ATFMIHMpD
...
- label: Season 2 - OP
  ...
  author: Linked Horizon
  spotify: [27iksNpaur1CcH0w8703by 5bIZNB6e83zaYYFHOe1YHz]

- label: Season 2 - ED
  title: Yuugure no Tori (夕暮れの鳥)
  author: Shinsei Kamattechan
  spotify: 79xW4zeNFlcp5VKyvWk3cC
```
...
- label: Season 3 Part 1 - ED
  ...
  author: Linked Horizon
  spotify: 2vH8JFJKfkAgZs1GFlOzGh

- label: Season 3 Part 2 - OP
  title: [Shoukei to Shikabane no Michi, (憧憬と屍の道)]
  author: Linked Horizon
  spotify: [0q8WLWTRdN7XcNCoZIxCu9 7lcTpZtdTyfiIgVIpmTVut]

- label: Season 3 Part 2 - ED
  title: Name of Love
  author: Cinema Staff
  spotify: 1h1E93CLB36dBweLtfeHpj
...
- label: Season 4 Part 1 - OP
  ...
  author: Shinsei Kamattechan
  spotify: [3tRPfCFAEv6wWyQO0YnGGV 3KhwEuqLNjHfsKaBDo1yVh]
  youtube: goXKlOozyx8

- label: Season 4 Part 1 - ED
  title: Shougeki (衝撃)
  author: Yuuko Andou (安藤裕子)
  spotify: 2GeK108DTmnSEfwwCR85mp

- label: Season 4 Part 2 - OP
  title: The Rumbling
  author: SiM
  spotify: [0KCSJzsQVxkloxoT7dyrqV 5JJKkuYGj99dfws5MiiJSR]

- label: Season 4 Part 2 - ED
  title: Akuma no Ko (悪魔の子)
  author: Ai Higuchi (ヒグチアイ)
  spotify: 2TVFbLCdzrX0RdhWNWJmdp
```
